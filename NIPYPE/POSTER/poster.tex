...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\colouredcircle{100} \textbf{Using multiple packages.} What if you wanted to leverage the
best features from different packages.

\colouredcircle{100} \textbf{Disseminating software.} As an algorithm
developer, which package should you develop for?

\colouredcircle{100} \textbf{Training users.} As a lab manager or
imaging center, how do you train users?

\colouredcircle{100} \textbf{Computing efficiently.} Can you leverage
computer clusters for efficient computong?

\colouredcircle{100} \textbf{Replicating methods.} Can you replicate
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\colouredcircle{100} \textbf{Multi-package support.} Uniform
cross-package interface (supports SPM, FSL, FreeSurfer components). 

\colouredcircle{100} \textbf{Minimal programming knowledge required.} A high
level scripting interface to design workflows intended for non-programmers.

\colouredcircle{100} \textbf{Parallel execution.} No additional coding
necessary for parallel execution of processing stages.

\colouredcircle{100} \textbf{Pedagogical.} Can be used as a teaching
tool and facilitates user training.
 
\colouredcircle{100} \textbf{Well documented.} Code documentation
becomes user documentation.

\colouredcircle{100} \textbf{Shared workflows.} Workflows separate
