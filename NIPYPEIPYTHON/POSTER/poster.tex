...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   ...
   \item \textbf{Parallel computing.} By using IPython's high-level
      facilities for distributed computing, Nipype can optimally execute
      any parallelizable analysis pipeline.  \vspace{0.3em}
    \end{list}
}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \headerbox{Results}{name=results,column=1,span=2,below=iworkflow2,above=funding}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
   ...
   \item \textbf{Intelligent routing.} Processes will be routed based
      on their attributes (e.g., os specificity) or user requirements
      (e.g., time). 
   \end{list}
}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \begin{list}{\labelitemi}{\leftmargin=1em}
      \compresslist
    \item \textbf{Integration.} We have developed a practical
      integration of IPython's parallel and distributed computing
      capabilities into Nipype's pipeline execution machinery. 
   \item \textbf{Codeless parallelization.} This provides an easy to
      use system for parallelizing analysis tasks with minimal effort
      and without the requirement for explicit parallel
      programming. 
   \item \textbf{Multi-package support.} Currently, one can execute
      SPM, FSL and a variety of FreeSurfer functions in parallel using
      this system on variety of different distributed computing
      architectures as long as they share a common file-system and have
      all underlying tools installed. 
    \end{list}
