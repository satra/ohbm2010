...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    An \textbf{enhanced interactive Python shell} and \textbf{an
    ...
    \emph{engines} and one \emph{controller}; code and data can be sent
    between them and multiple \emph{clients} can (even simultaneously)
    interact:
